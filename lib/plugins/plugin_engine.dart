...
/// One running plugin instance: owns its QuickJS runtime, evaluates the
...
/// Signature for fetching the current session's auth service (null when
/// logged out).
typedef AuthServiceAccessor = AuthService? Function();
